...
- After Coming Up with a simpler method then needing to hash for string comparison ive realized we could take advantage of taking the objects and rather than using a really intensive hash function like Sha256 or even lightweight ones we could take advantage of
